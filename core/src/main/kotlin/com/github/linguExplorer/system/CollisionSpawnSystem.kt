...
class CollisionSpawnSystem(
    ...
    override fun onTickEntity(entity: Entity) {
        ...
        tiledLayers.forEach {
                layer ->
            layer.forEachCell(entityX.toInt(),entityY.toInt(), SPAWN_AREA_SIZE) {
                    cell, x, y ->
    ...
    override fun handle(event: Event): Boolean {
        when(event) {
            is MapChangeEvent -> {
                ...
                //Hier wird verhindert das der Player sich außerhalb der Map bewegen kann
