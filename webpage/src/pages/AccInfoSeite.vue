    ...
    <div class="font-vcr m-0 text-black lg:w-[1100px] md:w-[800px] sm:w-[300px] w-[300px] bg-[#f6f5f1] min-h-screen flex flex-col justify-left">
      ...
      <main class="flex flex-col justify-start flex-grow lg:px-40 md:px-20 sm:px-4 px-4"> 
        ...
        <div class="flex flex-col w-full bg-[#d5d6d8] lg:p-8 md:p-6 sm:p-4 p-4 shadow-lg mt-6">
          ...
          <div class="input-group flex flex-col lg:mb-2 md:mb-2 sm:mb-1 mb-1">
            <label for="password" class="lg:text-[16px] md:text-[15px] sm:text-[14px] text-[14px]">altes Passwort</label>
            <input
              type="password"
              id="password"
              v-model="password"
          ...
          <div class="input-group flex flex-col lg:mb-2 md:mb-2 sm:mb-1 mb-1">
            <label for="newPassword" class="lg:text-[16px] md:text-[15px] sm:text-[14px] text-[14px]"
          ...
          <div class="input-group flex flex-col lg:mb-2 md:mb-2 sm:mb-1 mb-1">
            <label for="confirmPassword" class="lg:text-[16px] md:text-[15px] sm:text-[14px] text-[14px]"
