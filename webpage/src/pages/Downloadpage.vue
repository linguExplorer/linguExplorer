<template>
    <div class="font-vcr m-0 text-black w-full min-h-screen bg-[#f6f5f1] flex flex-col justify-start relative">
      ...
      <section class="flex flex-col justify-center items-center gap-11 w-full px-4 sm:px-6 mt-10 sm:mt-0">
        ...
        <!-- Button -->
        <button type="submit" class="hover-button lg:w-[200px] md:w-[180px] sm:w-[150px] w-[150px] mx-auto mb-8  mt-8 hover:opacity-80 hover:scale-110 transform transition-transform duration-200 ease-in-out">
