<template>
  <div class="min-h-screen w-full bg-[#f6f5f1]">
    ...
    <main class="max-w-full mx-auto">
      ...
      <img src="@/assets/xx_Images/xx_Images/sun.png" alt="Sonne" class="lg:min-w-[150px] md:min-w-[100px] sm:min-w-[70px] w-[70px] absolute z-1 translate-x-[-40vw] translate-y-[0vh] sm:translate-x-[-45.3vw] sm:translate-y-[3vh]" />
 ...
 <!--bg-[#ffb305]-->
    <ul class="list-none lg:mx-36 md:mx-20 sm:mx-9 mx-9 my-36 flex flex-col items-center ">
      ...
      <li class="lg:w-[1050px] md:w-[700px] sm:w-[300px] w-[300px] flex flex-col items-center justify-center bg-[#f6f5f1] mt-0 sm:mt-32 ">
        ...
        <p class="font-vcr text-left px-20 pt-8 lg:text-[20px] md:text-[16px] sm:text-[14px] text-[14px] sm:px-40 pt-4 pb-8">
...
<footer id="footer" class="bg-[#99b305] text-black text-xl">
    <section class="max-w-full lg:text-[20px] md:text-[16px] sm:text-[14px] text-[14px] mx-10 sm:mx-20 p-4 flex justify-between items-center">
