  ...
  <div class="min-h-screen w-full bg-[#f6f5f1]">
    ...
    <header class="bg-[#99b305] text-black sticky top-0 z-10">
      <section class="w-full py-2 flex justify-between items-center px-4">
        <img src="@/assets/xx_Images/xx_Images/wordmark/wordmark_hell_scaled.png" alt="Logo"
    ...
    <main class="max-w-full mx-auto">
      ...
      <img src="@/assets/xx_Images/xx_Images/sun.png" alt="Sonne"
      ...
      <img src="@/assets/xx_Images/xx_Images/cloud.png" alt="Wolke"
      ...
      <img src="@/assets/xx_Images/xx_Images/Cloud2.png" alt="Wolke"
      ...
      <img src="@/assets/xx_Images/xx_Images/wordmark/wordmark_scaled.png" alt="Linguexplorer"
      ...
      <button class="hover-button">
        <router-link to="/anmelden" class="nav-link" href="#">
          <img src="@/assets/xx_Images/xx_Images/Buttons/button play now.png" alt="Jetzt spielen"
        ...
        <ul class="list-none lg:mx-36 md:mx-20 sm:mx-9 mx-9 my-36 flex flex-col items-center ">
          ...
          <li
            ...
            <p class="font-vcr text-left px-10 sm:px-20 lg:text-[20px] md:text-[16px] sm:text-[14px] text-[14px] pt-2 pb-16">
              linguExplorer ist eine innovative Lernanwendung, die Schülerinnen und Schüler auf eine unterhaltsame
              Reise
              durch die englische Sprache mitnimmt. Diese Reise ist speziell darauf ausgelegt, den Herausforderungen
              der
              Fremdsprachenerlernung entgegenzutreten, die viele Jugendliche in ihrer Schullaufbahn bis zur Matura
              erleben.
            </p>
          </li>
          ...
          <li
            ...
            <h2 class="font-pixelsplitter text-center px-14 pt-14 lg:text-3xl md:text-2xl sm:text-xl text-xl">Ziele des
              Spiels:</h2>
            <p
              class="font-vcr text-left px-10 sm:px-20 lg:text-[20px] md:text-[16px] sm:text-[14px] text-[14px] pt-12 pb-8">
              Das primäre Ziel von linguExplorer ist es, die Motivation der Spieler zu steigern, indem sie auf
              spielerische
              Weise die englische Sprache erlernen. Das Spiel verbindet Lernen und Spaß, um den Schülern zu helfen,
              ihre
              Englischkenntnisse langfristig zu verbessern. Durch die interaktiven und herausfordernden Aufgaben soll
              nicht
          ...
          <li
            class="lg:w-[1050px] md:w-[700px] sm:w-[300px] w-[300px] flex flex-col items-center justify-center bg-[#f6f5f1] lg:mt-32 md:mt-20 sm:mt-20 mt-20">
            <h2 class="font-pixelsplitter text-center px-14 pt-14 lg:text-3xl md:text-2xl sm:text-xl text-xl">Gameplay:
            </h2>
            <p
              class="font-vcr text-left px-10 sm:px-20 lg:text-[20px] md:text-[16px] sm:text-[14px] text-[14px] pt-12 pb-8">
              linguExplorer ist ein Singleplayer-Lernspiel, das auf der Kombination von Spielspaß und Bildung basiert,
              ein
            ...
            <p
              ...
              An diesen Orten stehen dem Spieler eine Vielzahl von Minispielen zur Verfügung, die den Fokus auf
              spezifische
            ...
            <p
              ...
              Spielern jederzeit zur Verfügung und ermöglicht es ihnen, Inhalte nachzuschlagen und ihren
              Lernfortschritt
              zu verfolgen.
            </p>
          </li>
